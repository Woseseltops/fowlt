...
all: confusible_checker 3confusible_checker wopr_checker lexiconchecker/lexicon_checker splitchecker/split_checker runonchecker/runon_checker aspellchecker/aspell_checker
...
clean:
	rm -f $(ODIR)/*.o *~ core $(INCDIR)/*~ confusible_checker 3confusible_checker wopr_checker lexicon_checker split_checker runon_checker aspell_checker
