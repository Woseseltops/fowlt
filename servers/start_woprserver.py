...
try:
    if settings['wopr_large_corpus'] == '1':
        ...
        serverhelp.command(settings['wopr_location']+' -r server_sc -p ibasefile:woprserver/BNC_small.ibase,timbl:"-a1 +D",lexicon:woprserver/BNC_small.lex,port:2001,keep:1,mwl:5,max_distr:250,min_ratio:100');
