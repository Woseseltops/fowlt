...
try:
    if settings['wopr_large_corpus'] == '1':
        ...
        erverhelp.command(settings['wopr_location']+' -r server_sc -p ibasefile:woprserver/BNC_small.ibase,timbl:"-a1 +D",lexicon:woprserver/BNC_small.lex,port:3001,keep:1,max_distr:250');
